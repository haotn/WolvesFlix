...
public class DataGenerator {
	...
	public DataGenerator() {
		...
		userMinId = userDao.getMinId();
		userMaxId = userDao.getMaxId();
		videoMinId = videoDao.getMinId();
		videoMaxId = videoDao.getMaxId();
		commentMinId = commentDao.getMinId();
		commentMaxId = commentDao.getMaxId();
	}
