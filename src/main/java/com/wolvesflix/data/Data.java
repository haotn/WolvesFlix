...
public class Data {
	 ...
	 * "Trung", "Hùng", "Dũng", "Tiến", "�?ạt", "�?ức", "Trư�?ng", "Quang", "Huy",
	 ...
	 * "Thúy", "Liễu", "Cúc", "Thanh", "�?ào", "Ngân", "Thảo", "Chi", "Hạnh",
	 * "Trúc", "Trân", "Trâm", "Trinh", "An", "Quỳnh", "Loan", "Anh", "Lan" };
	 */
	/**
	 ...
	 * "Trần Huỳnh", "Phạm Huỳnh", "Lê Huỳnh", "Phan Huỳnh", "�?ào Huỳnh Thảo",
	 * "Trần Lê Huỳnh", "Nguyễn Lê Huỳnh", "Trần Nguyễn Huỳnh", "Trần Huy�?n",
	 * "Phạm Huy�?n", "Lê Huy�?n", "Phan Huy�?n", "Nguyễn Huy�?n" };
	 */
	/**
	 * EmailExtension
	 */
	...
	private void generateFemaleLastnameVi() {
		...
		String lastnames = "Nguyễn Thị;Trần Thị;Lê Thị;Phan Thị;Phạm Thị;Huỳnh Thị;Nguyễn Huỳnh;"
				...
				+ "Trần Nguyễn Huỳnh;Trần Huỳnn;Phạm Huỳnn;Lê Huỳnn;Phan Huyền;Nguyễn Huyền";
		for (String item : lastnames.split(";")) {
