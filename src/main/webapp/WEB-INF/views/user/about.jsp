...
<section class="section section--first section--bg"
	data-bg="${applicationScope.rootpath}/img/section/section.jpg">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="section__wrap">
					<!-- section title -->
					<h1 class="section__title">Về chúng tôi</h1>
					<!-- end section title -->

					<!-- breadcrumb -->
					<ul class="breadcrumb">
						<li class="breadcrumb__item"><a
							href="${applicationScope.rootpath}/home/index">Trang chủ</a></li>
						<li class="breadcrumb__item breadcrumb__item--active">Về
							chúng tôi</li>
					</ul>
					<!-- end breadcrumb -->
				</div>
		...
		<div class="row">
			...
			<div class="col-12">
				<h2 class="section__title">
					<b>WOLVESFLIX</b> – Nơi cung cấp trải nghiệm xem phim tuyệt vời
					nhất
				</h2>

				<p class="section__text">
					Một thực tế đã có từ lâu <b> rằng</b> người đọc sẽ bị phân tâm bởi
					nội dung có thể đọc được của một trang khi nhìn vào bố cục của nó.
					Điểm của việc sử dụng Lorem Ipsum là nó có sự phân phối các chữ cái
					bình thường ít nhiều, trái ngược với việc sử dụng.
				</p>

				<p class="section__text">
					'Nội dung ở đây, nội dung ở đây', làm cho nó giống như tiếng Anh <a
						href="#"> có thể đọc được </a> . Nhiều gói xuất bản trên máy tính
					để bàn và trình chỉnh sửa trang web hiện sử dụng Lorem Ipsum làm
					văn bản mô hình mặc định của họ và tìm kiếm 'lorem ipsum' sẽ phát
					hiện ra nhiều trang web vẫn còn sơ khai. Nhiều phiên bản khác nhau
					đã phát triển trong nhiều năm, đôi khi là do tình cờ, đôi khi là có
					chủ đích (tiêm chất hài hước và những thứ tương tự).
				</p>
			</div>
			<!-- end section title -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="feature">
					...
					<h3 class="feature__title">Chế độ Ultra HD</h3>
					<p class="feature__text">Nếu bạn định sử dụng một đoạn văn của
						Lorem Ipsum, bạn cần chắc chắn rằng không có bất kỳ điều gì đáng
						xấu hổ ẩn ở giữa văn bản.</p>
				</div>
			</div>
			<!-- end feature -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="feature">
					...
					<h3 class="feature__title">Thể loại phim đa dạng</h3>
					<p class="feature__text">Tất cả các trình tạo Lorem Ipsum trên
						Internet đều có xu hướng lặp lại các phần được xác định trước khi
						cần thiết, đây là phần đầu tiên.</p>
				</div>
			</div>
			<!-- end feature -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="feature">
					...
					<h3 class="feature__title">Các giải thưởng</h3>
					<p class="feature__text">Nó để làm một cuốn sách mẫu. Nó đã tồn
						tại không chỉ 5 thế kỷ, mà còn là bước nhảy vọt trong lĩnh vực sắp
						chữ điện tử, vẫn còn.</p>
				</div>
			</div>
			<!-- end feature -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="feature">
					...
					<h3 class="feature__title">Thông báo video mới</h3>
					<p class="feature__text">Nhiều phiên bản khác nhau đã phát
						triển trong nhiều năm, đôi khi là do tình cờ, đôi khi là cố ý.</p>
				</div>
			</div>
			<!-- end feature -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="feature">
					...
					<h3 class="feature__title">Tốc độ tải nhanh chóng</h3>
					<p class="feature__text">Nó đã tồn tại không chỉ 5 thế kỷ mà
						còn là bước nhảy vọt trong lĩnh vực sắp chữ điện tử.</p>
				</div>
			</div>
			<!-- end feature -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="feature">
					...
					<h3 class="feature__title">Hỗ trợ phụ đề đa ngôn ngữ</h3>
					<p class="feature__text">Nhiều phiên bản khác nhau đã phát
						triển trong nhiều năm, đôi khi là do tình cờ, đôi khi là cố ý.</p>
				</div>
			</div>
...
<section class="section section--dark">
	<div class="container">
		<div class="row">
			<!-- section title -->
			<div class="col-12">
				<h2 class="section__title">Làm sao để bắt đầu với FlixGo?</h2>
			</div>
			<!-- end section title -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="how">
					...
					<h3 class="how__title">Tạo một tài khoản</h3>
					<p class="how__text">Việc tìm một bộ phim hay chương trình
						truyền hình cũ trên internet chưa bao giờ là một vấn đề. Tuy
						nhiên, đây không phải là trường hợp của các bản phát hành mới.</p>
				</div>
			</div>
			<!-- ebd how box -->
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="how">
					...
					<h3 class="how__title">Chọn kế hoạch của bạn</h3>
					<p class="how__text">Việc tìm một bộ phim hay chương trình
						truyền hình cũ trên internet chưa bao giờ là một vấn đề. Tuy
						nhiên, đây không phải là trường hợp của các bản phát hành mới.</p>
				</div>
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="how">
					...
					<h3 class="how__title">Thưởng thức WolvesFlix</h3>
					<p class="how__text">Việc tìm một bộ phim hay chương trình
						truyền hình cũ trên internet chưa bao giờ là một vấn đề. Tuy
						nhiên, đây không phải là trường hợp của các bản phát hành mới.</p>
				</div>
