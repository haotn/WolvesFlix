			...
			<div class="col-12">
				<div class="section__wrap">
					...
					<ul class="breadcrumb">
						...
						<li class="breadcrumb__item breadcrumb__item--active">Liên hệ</li>
					</ul>
					<!-- end breadcrumb -->
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12 col-md-7 col-lg-8">
				<div class="row">
					<!-- section title -->
					<div class="col-12">
						<h2 class="section__title">Biểu mẫu liên hệ</h2>
					</div>
					<!-- end section title -->
					<div class="col-12">
						<form action="${applicationScope.rootpath}/home/contact" class="form form--contacts" method="post">
							<input type="text" class="form__input" placeholder="Tên của bạn" required="required" name="fullname"> <input type="email" class="form__input" placeholder="Email" required="required" name="email"> <input type="text" class="form__input" placeholder="Tiêu đề" required="required" name="subject">
							<textarea id="text" class="form__textarea" placeholder="Nội dung" required="required" name="content"></textarea>
			...
			<div class="col-12 col-md-5 col-lg-4">
				<div class="row">
					<!-- section title -->
					<div class="col-12">
						<h2 class="section__title">Thông tin</h2>
						<p class="section__text">Có một thực tế là người đọc sẽ bị phân tâm bởi nội dung có thể đọc được của một trang khi nhìn vào bố cục của nó. Điểm của việc sử dụng Lorem Ipsum là nó có sự phân phối các chữ cái bình thường ít nhiều, trái ngược với việc sử dụng.</p>
						<ul class="contacts__list">
							<li><a href="tel:+84982606291">+84 982 606 291</a></li>
							<li><a href="mailto:briansudosu@gmail.com">briansudosu@gmail.com</a></li>
						</ul>
						<ul class="contacts__social">
							<li class="facebook"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
										<path d="M20.9,2H3.1A1.1,1.1,0,0,0,2,3.1V20.9A1.1,1.1,0,0,0,3.1,22h9.58V14.25h-2.6v-3h2.6V9a3.64,3.64,0,0,1,3.88-4,20.26,20.26,0,0,1,2.33.12v2.7H17.3c-1.26,0-1.5.6-1.5,1.47v1.93h3l-.39,3H15.8V22h5.1A1.1,1.1,0,0,0,22,20.9V3.1A1.1,1.1,0,0,0,20.9,2Z" /></svg></a></li>
